...
Kill it and you have won the run.
...
node tools/sim.mjs --sweep hpDouble,90,110,130        # sweep a balance knob
...
because that would mean the arc does not terminate. Those checks need no judgement
